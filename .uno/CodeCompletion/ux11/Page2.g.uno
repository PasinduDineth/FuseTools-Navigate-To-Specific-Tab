...
public partial class Page2: Fuse.Controls.Page
{
    readonly Fuse.Navigation.Router router;
    internal global::Fuse.Controls.EdgeNavigator Page2Sidebar;
    ...
    void InitializeUX()
    {
        ...
        Page2Sidebar = new global::Fuse.Controls.EdgeNavigator();
        ...
        temp.LineNumber = 3;
        temp.FileName = "page2.ux";
        temp.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../../page2.js"));
        Page2Sidebar.Name = __selector0;
        Page2Sidebar.Children.Add(mainPanelBlur);
        Page2Sidebar.Children.Add(sidebar);
        Page2Sidebar.Children.Add(temp2);
        ...
        __g_nametable.Objects.Add(Page2Sidebar);
        __g_nametable.Objects.Add(mainPanelBlur);
        __g_nametable.Objects.Add(sidebar);
        __g_nametable.Objects.Add(sidebarFade);
        this.Children.Add(temp);
        this.Children.Add(Page2Sidebar);
    }
    static global::Uno.UX.Selector __selector0 = "Page2Sidebar";
